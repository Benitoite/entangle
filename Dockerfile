...
CMD echo "This is a test..." && echo $(date +%Y%0m%0d%0k%0M%0S)>stamp && mkdir /hi/$(cat stamp) && entangle ; cp /Capture/* /hi/$(cat stamp) && echo "Complete Success. " && echo "THATS ALL FOLKS!!!" && bash
